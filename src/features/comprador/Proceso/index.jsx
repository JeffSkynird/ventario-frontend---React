...
import { Box, Breadcrumbs, Button, Chip, Grid, IconButton, Paper, Skeleton, Tab, Tabs, Typography, useMediaQuery } from '@mui/material';
          ...
          <div style={{ padding:10,marginTop:10 }}>
            ...
            <Grid item xs={12}>
              ...
              <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', marginTop: 10 }}>
                <Typography style={{fontWeight:'bold'}}><IconButton style={{ display: page > 1 ? 'inline' : 'none' }} onClick={() => setPage(page - 1)}>
                  <ArrowLeftIcon />
